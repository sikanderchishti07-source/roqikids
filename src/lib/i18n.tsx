...
const ar = {
  ...
  hero: {
    pill: "قصص فريدة لطفل فريد",
    h1a: "اصنع قصة لطفلك",
    h1b: "تُشبهه وتُضيءَ خياله",
    body: "نحوّل اسم طفلك، اهتماماته ومناسباتكم الخاصة إلى مغامرة ساحرة يكون بطلها طفلك.",
    checklist: [
      "اسمه داخل الحكاية",
    ...
    cta2: "استعرض القصص",
    promo: "خصم 15% على أول قصة لطفلك – استخدم الكود:",
    promoCode: "AHLAN15",
    stackAlt: "أغلفة قصص رُقي: القبطان الصغير، الأميرة الشجاعة، رحلة الديناصورات، مهمة في الفضاء",
    badge: ["شخصية القصة", "بشكل طفلك"],
    assurances: ["آمنة تمامًا للأطفال", "توصيل سريع للدول", "طباعة عالية الجودة"],
    features: [
      { title: "شخصيات تشبه طفلك", body: "نصمم شخصية القصة لتشبه ملامح طفلك واهتماماته." },
      { title: "قصص تعليمية ملهمة", body: "محتوى هادف يعزز القيم واللغة بالنفس والخيال." },
      { title: "مناسبات لا تُنسى", body: "قصص خاصة لأعياد الميلاد، النجاح، بداية المدرسة والمزيد." },
      { title: "هدية تبقى ذكراها", body: "كتاب جميل يبقى مع طفلك ويصبح ذكرى ثمينة مدى الحياة." },
    ],
    stats: [
      { value: "10,000+", label: "أسرة سعيدة" },
      { value: "50,000+", label: "قصة تم تصميمها" },
      { value: "100+", label: "دولة نقوم بالتوصيل إليها" },
...
const en = {
  ...
  hero: {
    pill: "Unique stories for a unique child",
    h1a: "Create a story for your child",
    h1b: "that looks like them and lights up their imagination",
    body: "We turn your child's name, interests and your special occasions into a magical adventure where your child is the hero.",
    checklist: [
    ...
    cta2: "Browse the stories",
    promo: "15% off your child's first story – use code:",
    promoCode: "AHLAN15",
    stackAlt: "Roqi story covers: The Little Captain, The Brave Princess, The Dinosaur Journey, Mission in Space",
    badge: ["A character", "that looks like your child"],
    assurances: ["Completely child-safe", "Fast worldwide delivery", "High-quality printing"],
    features: [
      { title: "Characters that look like your child", body: "We design the story's hero to match your child's features and interests." },
      { title: "Inspiring educational stories", body: "Meaningful content that builds values, language, confidence and imagination." },
      { title: "Unforgettable occasions", body: "Special stories for birthdays, achievements, the first day of school and more." },
      { title: "A gift that lasts", body: "A beautiful book that stays with your child and becomes a lifelong keepsake." },
    ],
    stats: [
      { value: "10,000+", label: "Happy families" },
      { value: "50,000+", label: "Stories created" },
      { value: "100+", label: "Countries we deliver to" },
